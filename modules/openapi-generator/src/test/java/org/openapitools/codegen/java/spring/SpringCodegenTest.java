...
//        Assert.assertEquals(codegen.additionalProperties().get(SpringCodegen.UNHANDLED_EXCEPTION_HANDLING), true);
    ...
    public void testOneOf5381() throws IOException {
        ...
        DefaultGenerator generator = new DefaultGenerator();
        // another occurence of #18715. Even if setHateos is true for java, it was false for mustache
        // after the fix for #19715 the next line is commented to avoid the generation of extends RepresentationModel<Foo>
